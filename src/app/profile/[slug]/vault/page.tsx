  ...
  const filteredAndSortedEntries = useMemo(() => {
    return entryData
      ...
      .sort((a, b) => {
        const getSortValue = (
          entry: IVNVaultEntry,
          key: keyof IVNVaultEntry | keyof IVN
        ) => {
          if (key in entry) {
    ...
    <div className="w-full py-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end gap-4 mb-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end gap-2 w-full sm:w-auto">
          <Select
            value={sortBy}
            onValueChange={(value) => setSortBy(value as keyof IVN)}
          >
          ...
          <Button
            variant="outline"
            className="w-full md:w-10 h-10 p-0 flex-shrink-0"
          ...
          <Select
            value={statusFilter}
            onValueChange={(value) =>
              setStatusFilter(value as IVaultStatus | "All")
            }
          >
            <SelectTrigger className="w-full sm:w-[180px]">
            ...
            <SelectContent>
              ...
              <SelectItem value={IVaultStatus.Finished}>
                {IVaultStatus.Finished}
              </SelectItem>
              <SelectItem value={IVaultStatus.Reading}>
                {IVaultStatus.Reading}
              </SelectItem>
              <SelectItem value={IVaultStatus.Dropped}>
                {IVaultStatus.Dropped}
              </SelectItem>
              <SelectItem value={IVaultStatus.ToRead}>
                {IVaultStatus.ToRead}
              </SelectItem>
            </SelectContent>
          </Select>
